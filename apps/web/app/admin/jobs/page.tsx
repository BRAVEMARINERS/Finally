...
export default function Page() {
  return <main className="container dashboard"><Sidebar title="Admin" links={links} /><section><PageHeader title="Jobs" subtitle="Admin jobs management starter page." /><div className="card"><p className="muted">This page is ready for management logic.</p></div></section></main>;
}
